...
// POST /api/checkout/webhook  — Stripe webhook (no auth, raw body)
...
// middleware to expose raw body for webhook verification
function express_raw_body(req, res, next) {
  // This is set up in server.js via express.raw()
  next();
}
