...
export const INFINITI_PRESETS = [
  {
    ...
    desc: 'Purple carbon fiber paired with Alcantara side grips and black stitching. This wheel is already made, sold exactly as shown, and ready to ship for Infiniti G25, G35, G37 and G37X models from 2009–2013.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    ...
    fixedInfoBody: 'Purple Rain is already made and ships exactly as shown. Infiniti customization is not available yet. This wheel has no airbag, heated-steering, or lane-assist options.',
...
export const BMW_PRESETS = [
  ...
  ,
  {
    ...
    name: 'M READY CARBON',
    base_price: 399.99,
    compat: 'Fits select BMW models · Contact to confirm fitment',
    features: [
      'Buttons Included',
    ...
    desc: 'Classic carbon fiber BMW wheel with included buttons and paddle shifters, a BMW pattern stripe, gloss black inlay, and perforated leather sides. This wheel is already made, sold exactly as shown, and ready to ship.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    allowAirbagCover: false,
    ...
    fixedInfoTitle: 'READY TO SHIP BMW WHEEL',
    fixedInfoBody: 'This BMW wheel is already made and ships exactly as shown. Buttons and paddle shifters are included. It features classic carbon fiber, a BMW pattern stripe, gloss black inlay, and perforated leather sides. No airbag is included with this listing.',
    fixedBuildNote: 'Ready to ship · Already made',
    footerMeta: '🛡 6 Month Warranty · Ready to Ship · Already Made',
  }
  ,
