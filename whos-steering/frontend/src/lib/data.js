...
export const TOP_BOTTOM_MATS = [
  { n: 'Smooth Leather',     d: '#5C3A1E', col: true,  carbon: false  },
  { n: 'Classic Carbon',      d: '#111111', col: false, carbon: true,  cType: 'classic'   },
  { n: 'Forged Carbon',       d: '#1A1F28', col: false, carbon: true,  cType: 'forged'    },
  { n: 'Honeycomb Carbon',    d: '#0A0A0A', col: false, carbon: true,  cType: 'honeycomb' },
  { n: 'Alcantara',           d: '#3A3A3A', col: true,  carbon: false  },
...
export const BMW_PRESETS = [
  ...
  ,
  {
    ...
    images: [
      '/bmw/red-desire-1.jpg',
      '/bmw/red-desire-2.jpg',
      '/bmw/red-desire-3.jpg',
      '/bmw/red-desire-4.jpg',
    ],
    desc: "A bold ready-to-ship F-Series BMW wheel finished in classic carbon fiber with striking red inlays, perforated leather sides, a red 12 o'clock stripe, and BMW tri-color stitching. Buttons and paddle shifters are already included. Built and ready to ship exactly as shown.",
    isPreset: true,
    customizable: false,
    readyToShip: true,
    allowAirbagCover: false,
    ...
    productTypeLabel: 'BMW · READY TO SHIP',
    fixedInfoTitle: 'BUILT & READY TO SHIP',
    fixedInfoBody: "Red Desire is already built and ready to ship exactly as shown for all F-Series BMW's. It features classic carbon fiber, red inlays, perforated leather sides, a red 12 o'clock stripe, and BMW tri-color stitching. Buttons and paddle shifters are included.",
    fixedBuildNote: 'Ready to ship · Already built',
    footerMeta: '🛡 6 Month Warranty · Ready to Ship · Already Built',
    fixedConfig: {
      topBottomMat: 'Classic Carbon Fiber',
