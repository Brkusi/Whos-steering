...
export const INFINITI_PRESETS = [
  {
    ...
    desc: 'A striking ready-to-ship Infiniti wheel finished in purple carbon fiber with Alcantara side grips and clean black stitching. Already built and ready to transform G25, G35, G37 and G37X models from 2009–2013 without the custom-build wait.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    ...
    fixedInfoBody: 'Purple Rain is already built and ready to ship exactly as shown. Purple carbon fiber and Alcantara create a bold premium finish without the custom-build wait. This listing does not include airbag, heated-steering, or lane-assist options.',
  ...
  {
    id: 'infiniti-purple-craze',
    brand: 'INFINITI',
    name: 'PURPLE CRAZE',
    base_price: 549.99,
    compat: 'Fits Infiniti Q50 2018+ / Q60 2017+',
    vehicleYear: 'Q50 2018+ / Q60 2017+',
    vehicleModel: 'Q50 / Q60',
    features: [
      'Purple Carbon Fiber Top & Bottom',
      'Perforated Leather',
      'Purple Stitching',
      'Purple Inlays',
    ],
    images: [
      '/infiniti/purple-craze-1.jpg',
      '/infiniti/purple-craze-2.png',
      '/infiniti/purple-craze-3.jpg',
      '/infiniti/purple-craze-4.jpg',
    ],
    desc: 'A bold ready-to-ship Infiniti setup featuring purple carbon fiber top and bottom, perforated leather, purple stitching, and matching purple inlays. Already built for Q50 2018+ and Q60 2017+ drivers who want a standout finish without waiting on a custom build.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    allowAirbagCover: false,
    ...
    productTypeLabel: 'INFINITI · READY TO SHIP',
    fixedInfoTitle: 'BUILT & READY TO SHIP',
    fixedInfoBody: 'Purple Craze is already built and ready to ship exactly as shown. Purple carbon fiber top and bottom, perforated leather, purple stitching, and matching purple inlays create a complete show-car look without the custom-build wait.',
    fixedBuildNote: 'Ready to ship · Already built',
    footerMeta: '🛡 6 Month Warranty · Ready to Ship · Already Built',
    fixedConfig: {
      topBottomMat: 'Purple Carbon Fiber',
  ...
  },
  {
    ...
    desc: 'Gold carbon fiber meets black perforated side grips and a clean black top stripe for a sharp, premium contrast. This Infiniti wheel is already built and ready to ship for G25, G35, G37 and G37X models from 2009–2013.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    allowAirbagCover: false,
    ...
    productTypeLabel: 'INFINITI · READY TO SHIP',
    fixedInfoTitle: 'BUILT & READY TO SHIP',
    fixedInfoBody: 'Gold Rush is already built and ready to ship exactly as shown. Gold carbon fiber, black perforated side grips, black stitching, and a black top stripe deliver a finished premium look without the custom-build wait. Airbag, heated-steering, and lane-assist options are not included.',
    fixedBuildNote: 'Ready to ship · Already built',
    footerMeta: '🛡 6 Month Warranty · Ready to Ship · Already Built',
    fixedConfig: {
...
export const BMW_PRESETS = [
  ...
  ,
  {
    id: 'bmw-ready-classic-carbon',
    brand: 'BMW',
    name: 'CARBON CLASSIC',
    base_price: 399.99,
    compat: "Fits All F-Series BMW's",
    features: [
      'Buttons Included',
    ...
    images: ['/bmw/bmw-ready-carbon-1.jpg', '/bmw/bmw-ready-carbon-2.jpg', '/bmw/bmw-ready-carbon-3.jpg'],
    desc: 'An OEM-inspired F-Series BMW wheel upgraded with classic carbon fiber, perforated leather sides, a BMW-pattern top stripe, and gloss black inlays. Buttons and paddle shifters are already installed, and the wheel is built and ready to ship.',
    isPreset: true,
    customizable: false,
    readyToShip: true,
    allowAirbagCover: false,
  ...
  ,
  {
    ...
    features: [
      'Carbon Fiber Top & Bottom',
      'Carbon Fiber Inlays',
      'BMW Tri-Color Stitching',
      "BMW Tri-Color 12 O'Clock Stripe",
      'Perforated Leather Sides',
    ],
    images: [
      '/bmw/e-carbone-1.jpg',
    ...
    footerMeta: '🛡 6 Month Warranty · Ready to Ship · Already Built',
    readyShipOption: {
      key: 'paddleShifterSpaceInserts',
      label: 'Paddle Shifter Space Inserts',
      priceDelta: 20,
      selectedPrice: 499.99,
      note: 'INSERTS ONLY — paddle shifters are NOT included.',
    },
    fixedConfig: {
      topBottomMat: 'Classic Carbon Fiber',
      topBottomCarbonCol: 'Classic Carbon',
      ...
      sideCol: '#111111',
      stitchColor: 'BMW Tri-Color',
      stripe: 'BMW Tri-Color',
      inlay: 'Carbon Fiber',
      paddleShifters: 'Not Included',
    },
  },
  {
