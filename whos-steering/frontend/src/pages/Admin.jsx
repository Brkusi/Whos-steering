...
function adminCarbonColor(material, hex) {
  if (!hex) return '—';
  const list = ['Classic Carbon','Matte Carbon'].includes(material) ? CLASSIC_CARBON_COLORS : material === 'Forged Carbon' ? FORGED_CARBON_COLORS : HONEYCOMB_CARBON_COLORS;
