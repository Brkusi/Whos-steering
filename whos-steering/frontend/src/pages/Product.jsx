    ...
    <div style={{ paddingTop: 88, minHeight: '100vh' }}>
      <div className="product-layout">
        ...
        <div style={{ padding: '36px 32px', overflowY: 'auto' }}>
          <div style={{ fontFamily: 'Arial, sans-serif', fontSize: 14, letterSpacing: .6, color: 'var(--y)', textTransform: 'uppercase', marginBottom: 8 }}>
          ...
          <div style={{ fontSize: 14, color: 'var(--t)', letterSpacing: .6, textTransform: 'uppercase', marginBottom: 24 }}>Starting price · Options may vary</div>

          {/* Features */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 22 }}>
            {features.map(f => (
              <div key={f} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: 'var(--t)' }}>
          ...
          <div style={{ borderTop: '1px solid var(--b)', paddingTop: 18, display: 'flex', flexDirection: 'column', gap: 9 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 14, color: 'var(--t)' }}>
              <span style={{ color: 'var(--y)', fontSize: 14 }}>⏱</span> 3–5 week custom build
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 14, color: 'var(--t)' }}>
              <span style={{ color: 'var(--y)', fontSize: 14 }}>🛡</span> 6 Month Manufacturer Warranty
            </div>
          </div>
        </div>
      </div>
